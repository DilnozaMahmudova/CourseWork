    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        init {
            itemView.apply {
                ...
                did.setOnClickListener { listenerDone?.invoke(getItem(adapterPosition)) }
                didnt.setOnClickListener { listenerCancel?.invoke(getItem(adapterPosition)) }
            }
        }
        fun bind()=bindItem {
            ...
            next.setColorFilter(Color.TRANSPARENT)
        }
